          ...
          <ul>
            ...
            <li className="pw-section">
              <div className="area-style">
                ...
                <p className="help-style">
                  <AiOutlineCheck /> 영문대소문자/숫자/특수문자 조합, 8 ~ 16자
                </p>

                <br />

                <label htmlFor="pw2Area" className="label-style">
                  비밀번호 확인
                </label>
                <input
                  type="password"
            ...
            <li className="birth-section">
              <div className="area-style">
                ...
                <p className="help-style">
                  <AiOutlineCheck /> - 를 제외한 8글자 ex) 19990514
                </p>
              </div>
            </li>
            ...
            <li id="terms-section">
              ...
              <div className="termsBox">
                ...
                <p>
                  ο 수집항목 : 이름 , 생년월일 , 성별 , 로그인ID , 비밀번호 , 비밀번호 질문과 답변 , 자택 전화번호 , 자택 주소 , 휴대전화번호 , 이메일 , 직업 ,
                  회사명 , 부서 , 직책 , 회사전화번호 , 취미 , 결혼여부 , 기념일 , 법정대리인정보 , 서비스 이용기록 , 접속 로그 , 접속 IP 정보 , 결제기록
                ...
                <p>
                  ...
                  ο 회원 관리
                  <br />
                  회원제 서비스 이용에 따른 본인확인 , 개인 식별 , 연령확인 , 만14세 미만 아동 개인정보 수집 시 법정 대리인 동의여부 확인 , 고지사항 전달 ο
                  마케팅 및 광고에 활용
                  <br />
